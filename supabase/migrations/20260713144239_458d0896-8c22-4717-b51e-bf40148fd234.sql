...
REVOKE ALL ON FUNCTION public.ir_upsert_profiles(jsonb) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.ir_snapshot_now() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.ir_drain_queue(int) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.ir_list_profiles() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.ir_consortium_trend() FROM PUBLIC;

GRANT EXECUTE ON FUNCTION public.ir_upsert_profiles(jsonb) TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.ir_snapshot_now() TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.ir_drain_queue(int) TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.ir_list_profiles() TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.ir_consortium_trend() TO authenticated, service_role;
