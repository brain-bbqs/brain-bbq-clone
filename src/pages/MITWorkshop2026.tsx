...
const DAY2_ROWS: AgendaRow[] = [
  ...
  ["10:00", "11:00", "Brainhack Planning — BBQS Policies. Intro new Brainhack sessions and organize meeting locations.", "Singleton", "Yes", undefined, "Brainhack session leads"],
