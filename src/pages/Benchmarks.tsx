      ...
      <div className="px-6 py-8">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm text-muted-foreground">{benchmarkResources.length} benchmarks</span>
          </div>
        </div>
        <div className="ag-theme-alpine rounded-lg border border-border overflow-hidden" style={{ height: "calc(100vh - 240px)" }}>
          <AgGridReact<Resource>
            rowData={benchmarkResources} columnDefs={columnDefs} defaultColDef={defaultColDef}
