      ...
      <div className="px-6 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mb-4">
            Curated datasets for behavioral and neural analysis.
          </p>
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm text-muted-foreground">{datasetResources.length} datasets</span>
          </div>
        </div>
        <div className="ag-theme-alpine rounded-lg border border-border overflow-hidden" style={{ height: "calc(100vh - 240px)" }}>
          <AgGridReact<Resource>
            rowData={datasetResources} columnDefs={columnDefs} defaultColDef={defaultColDef}
