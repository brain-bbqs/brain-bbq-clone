...
export const SEATING_PLAN: SeatingTable[] = [
  ...
  },
  {
    ...
    seats: [
      ...
      { name: "Talmo Pereira", institution: "Salk Institute", role: "PI", domain: "B" },
  ...
  {
    number: 7,
    theme: "BBQS Data Infrastructure I — BARD.CC",
    domains: "F",
    seats: [
      { name: "Brock Wester", institution: "JHU APL", role: "PI (anchor)", domain: "F" },
      { name: "Han Yi", institution: "JHU APL", role: "Co-I", domain: "F" },
      { name: "Rahul Hingorani", institution: "JHU APL", role: "Research Staff", domain: "F" },
      { name: "Nicole Tregoning", institution: "Johns Hopkins University", role: "Research Staff", domain: "F" },
      { name: "Cody Baker", institution: "Dartmouth College", role: "Research Staff", domain: "F" },
      { name: "Yaroslav Halchenko", institution: "Dartmouth / DANDI", role: "Co-I", domain: "F" },
      { name: "Nima Dehghani", institution: "MIT", role: "Research Staff", domain: "F" },
  ...
  {
    number: 8,
    theme: "BBQS Data Infrastructure II — EMBER",
    domains: "F",
    seats: [
      { name: "Laura Cabrera", institution: "Penn State", role: "PI (anchor)", domain: "F" },
      { name: "Jennifer Wagner", institution: "Penn State", role: "Co-I", domain: "F" },
      { name: "Kristofer Bouchard", institution: "UC Berkeley / LBNL", role: "PI", domain: "F" },
      { name: "Oliver Ruebel", institution: "Lawrence Berkeley National Lab", role: "Co-I", domain: "F" },
      { name: "Meaghan Perdue", institution: "UMass Chan Medical School", role: "Postdoc/Grad", domain: "F" },
      { name: "David Kennedy", institution: "UMass Chan Medical School", role: "PI", domain: "F" },
      { name: "Satrajit Ghosh", institution: "MIT", role: "PI", domain: "F" },
      { name: "Jyl Boline", institution: "Informed Minds", role: "Project Manager", domain: "ADMIN" },
      { name: "Darrell De Freitas", institution: "University of Pennsylvania", role: "Software Developer", domain: "F" },
    ],
  },
  {
    number: 9,
    theme: "Cross-Consortium Bridge / Advisory",
    domains: "Advisory + Industry",
    seats: [
  ...
  },
  {
    ...
    seats: [
      ...
      { name: "Tristan Daniel (alt)", institution: "Georgia Tech", role: "Postdoc/Grad" },
      { name: "Open seat" },
    ],
  },
];
